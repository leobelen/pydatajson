...
def catalog_error(options=None):
    default_options = {
        ...
        1,
        "validator_value":
        ["dataset", "title", "description", "publisher", "superThemeTaxonomy"]
    }
...
def missing_catalog_dataset():
    return catalog_error({
        'message':
        "%s is a required property" % jsonschema_str('dataset'),
        'dataset':
        None,
    })
...
def missing_catalog_description():
    return catalog_error({
        'message':
        "%s is a required property" % jsonschema_str('description'),
    })
...
def invalid_catalog_publisher_type():
    return catalog_error({
        'instance':
        ["Ministerio de Modernización", "datos@modernizacion.gob.ar"],
        "validator":
        "type",
        "path": ["publisher"],
        "message":
...
def invalid_publisher_mbox_format():
    return catalog_error({
        ...
        2,
        "message":
        "%s is not a %s" % (jsonschema_str('datosATmodernizacion.gob.ar'),
...
def null_catalog_publisher():
    return catalog_error({
        ...
        2,
        "message":
        "None is not of type %s" % jsonschema_str('object'),
        "path": ['publisher'],
        "validator":
        'type',
        "validator_value":
...
def malformed_uri():
    return catalog_error({
        "instance":
        "datos.gob.ar/superThemeTaxonomy.json",
        "validator":
        "format",
        "path": ["superThemeTaxonomy"],
        "message":
        "%s is not a %s" %
...
def invalid_theme_taxonomy():
    return catalog_error({
        ...
        "message":
        "Los ids [%s] estan repetidos en mas de un `theme`" %
        jsonschema_str('convocatorias'),
        "error_code":
        2,
        "validator_value":
        "Chequea ids duplicados en themeTaxonomy"
    })
...
def repeated_downloadURL():
    return catalog_error({
        ...
        "message":
        "DownloadURL's [%s] estan repetidas en mas de un `distribution`" %
        jsonschema_str(
        ...
        2,
        "validator_value":
        "Chequea downloadURL's duplicados en las distribuciones"
    })

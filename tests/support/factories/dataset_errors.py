...
def dataset_error(options=None):
    default_options = {
        ...
        "validator":
        "anyOf",
        "path": ["dataset", 0, "accrualPeriodicity"],
        "message":
        "u'RP1Y' is not valid under any of the given schemas",
        "error_code":
        2,
        "validator_value": [{
...
def missing_dataset_title():
    return dataset_error({
        ...
        1,
        "validator_value": [
            "title", "description", "publisher", "superTheme", "distribution",
            "accrualPeriodicity", "issued"
        ],
        "dataset_title":
        None,
    })
...
def malformed_temporal():
    return dataset_error({
        ...
        "validator_value": [{
            "pattern":
            "^(\\d{4}-\\d\\d-\\d\\d(T\\d\\d:\\d\\d:\\d\\d(\\.\\d+)?)?(([+-]\\d\\d:\\d\\d)|Z)?)\\/(\\d{4}-\\d\\d-\\d\\d(T\\d\\d:\\d\\d:\\d\\d(\\.\\d+)?)?(([+-]\\d\\d:\\d\\d)|Z)?)$",
            "type":
            "string"
        }, {
            "type": "null"
...
def too_long_field_title():
    return dataset_error({
        ...
        "validator":
        "anyOf",
        "path": ["dataset", 0, "distribution", 0, "field", 3, "title"],
        "message":
